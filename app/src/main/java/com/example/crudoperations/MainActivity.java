...
import com.example.crudoperations.R;
...
public class MainActivity extends AppCompatActivity implements CourseRVAdapter.CourseClickInterface {
    ...
    private ArrayList<RVModal> courseRVModalArrayList;
...
//        setContentView(R.layout.bottom_sheet_layout);
    ...
    private void getCourses() {
        ...
        databaseReference.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                ...
                courseRVModalArrayList.add(snapshot.getValue(RVModal.class));
    ...
    private void displayBottomSheet(RVModal modal) {
        ...
        priceTV.setText("Ksh." + modal.getCoursePrice());
        ...
        editBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(MainActivity.this, EditCourse.class);
